...
<head>
    ...
    <title>điện thoại đạt V.I.P</title>
    <!-- Bootstrap core CSS -->
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <div>
                    <a href="#" class="list-group-item active">dienthoaidat
                    </a>
                    <ul class="list-group">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="btn-group alg-right-pad">
                        <button type="button" class="btn btn-default"><strong>18  </strong>Sản phẩm</button>
                        <div class="btn-group">
